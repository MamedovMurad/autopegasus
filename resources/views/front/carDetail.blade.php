...
<link rel="stylesheet" href="{{asset('/front/autima/')}}/assets1/css/font-electro.css">
            
            <link rel="stylesheet" href="{{asset('/front/autima/')}}/assets1/vendor/animate.css/animate.min.css">
            <link rel="stylesheet" href="{{asset('/front/autima/')}}/assets1/vendor/hs-megamenu/src/hs.megamenu.css">
            <link rel="stylesheet" href="{{asset('/front/autima/')}}/assets1/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css">
            <link rel="stylesheet" href="{{asset('/front/autima/')}}/assets1/vendor/fancybox/jquery.fancybox.css">
